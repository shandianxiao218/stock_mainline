...
- 2026-05-01 已新增 `docs/软件设计说明书.md`，对照原始 SRS 梳理当前设计、模块、数据流、API、性能方案、主要差距，并在文档末尾维护需求追踪表。
- 2026-05-01 已补充软件设计说明书第 8 章评分模型设计，明确热度分、延续性分、风险扣分、资金接力断裂、置信度的具体计算公式、字段定义和数据来源。
- 2026-05-01 已在软件设计说明书末尾追加软件实现情况核对表，按设计逐项核对架构、数据库、数据流、评分模型、API、前端、权限审计、性能和测试；同时修正板块快照表名为 `local_sector_snapshot_daily`。
